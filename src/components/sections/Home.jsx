    ...
    return (
        ...
        <section id="home" className="min-h-screen flex items-center justify-center relative">
            ...
            <div className="text-center z-10 px-4">
                ...
                <p className="text-gray-400 text-lg mb-8 max-w-2xl mx-auto">
                    Currently, I'm working with FIS as an Analyst. I have a total experience of 5+ years and have hands on experience in handling backend and frontend systems and developing excellent solutions.
                </p>
                ...
                <div className="flex justify-center space-x-4">
                    ...
                    <a href="#contact" className="border border-blue-600/90 text-blue-500 py-3 px-5 rounded font-medium transition-all duration-200 hover:-translate-y-0.5 hover:shadow-[0_0_15px_rgba(59, 130, 246, 0.2)] hover:bg-blue-500/10">
                        Contact Me
                    </a>
